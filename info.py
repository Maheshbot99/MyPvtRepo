...
# Custom Chats
FILE_CHANNEL = int(environ.get('FILE_CHANNEL', '-1001945421680'))
FILE_CHANNEL_LINK = environ.get('FILE_CHANNEL_LINK', 'https://t.me/+bOZsUpkXz6JjZDU1')
...
# FSUB
auth_channel = environ.get('AUTH_CHANNEL', '-1001840650798')
...
S_GROUP = environ.get('S_GROUP',"https://t.me/MsMovieRequests")
MAIN_CHANNEL = environ.get('MAIN_CHANNEL',"https://t.me/NewCinemaStore")
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/MsMovieRequests')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/NewCinemaStore')
MSG_ALRT = environ.get('MSG_ALRT', 'Piracy Is Crime')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', 0))
FILE_CHANNEL = int(environ.get('FILE_CHANNEL', -1001945421680))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'NewCinemaStore')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001945421680')).split()]
